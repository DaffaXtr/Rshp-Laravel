...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --sidebar-width: 260px; /* Dipertahankan karena Bootstrap tidak memiliki kelas lebar tetap */
        ...
        .sidebar {
            ...
            overflow-y: auto;
            z-index: 1050; /* Pastikan di atas konten utama */
        }
        ...
        .sidebar .nav-link {
            ...
            border-radius: 8px; /* Sudut membulat Bootstrap */
            margin: 5px 15px;
        }
    ...
    <div id="app">
        ...
        <div class="sidebar">
            ...
            <div class="profile-info">
                <p class="mb-0 text-white fw-bold">{{ session('user_name') ?? 'Guest' }}</p>
                <small class="text-muted">{{ session('user_role_name') ?? 'Role Name' }}</small>
            </div>
            ...
            <nav class="nav flex-column">
                ...
                <!-- Logout Button (di bawah, dipicu JS) -->
                <div class="p-3">
        ...
        <div class="main-content">
            ...
            <main class="py-4">
                <!-- Tempat Konten dari @yield('content') -->
                @yield('content')
            </main>
        </div>
