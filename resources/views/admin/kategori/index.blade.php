...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-list-ul me-2"></i> Manajemen Kategori Tindakan
        </h1>
    ...
    <div class="card shadow mb-4 border-0 rounded-3">
        <div class="card-header py-3 bg-white rounded-top-3">
            <h6 class="m-0 fw-bold" style="color: var(--primary-blue);">Daftar Kategori Tindakan</h6>
        </div>
        <div class="card-body">
                ...
                <table class="table table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        @foreach ($kategori as $kat)
                            <tr>
                                <td class="text-center">{{ $kat->idkategori }}</td>
                                ...
                                <td class="text-center" style="min-width: 120px;">
                                    ...
                                    <form action="#" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-sm btn-danger shadow-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus kategori ini?')">
